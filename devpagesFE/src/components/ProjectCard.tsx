const ProjectCard = ({ project }: { project: { title: string, description: string, image: string } }) => {
    return (
        <div className="flex flex-col gap-2 mb-5">
            <a href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100">
                <img className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg" src={project.image} alt="" />
